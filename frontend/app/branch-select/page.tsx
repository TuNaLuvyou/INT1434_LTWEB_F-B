    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xl">
        ...
        <div className="mt-6 text-center">
          <button
            onClick={() => logout()}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-900 hover:bg-rose-950/40 border border-zinc-800 hover:border-rose-900/50 text-xs font-semibold text-zinc-400 hover:text-rose-400 transition-all cursor-pointer shadow-sm"
          >
