        ...
        <div className="relative z-10 text-center max-w-lg space-y-12 px-8">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl font-extrabold tracking-tight leading-tight text-white">
              <span className="whitespace-nowrap">Quản trị & Phân phối</span> <br />
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16 relative overflow-hidden">
        ...
        <div className="w-full max-w-md mx-auto relative z-10">
          {resolvedParams.reason === 'expired' && (
            <div className="mb-4 bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-3.5 text-center">
              <p className="text-xs font-medium text-yellow-300">Phiên làm việc hết hạn, vui lòng đăng nhập lại</p>
            </div>
          )}
          {resolvedParams.reason === 'forbidden' && (
            <div className="mb-4 bg-rose-500/10 border border-rose-500/30 rounded-2xl p-3.5 text-center">
              <p className="text-xs font-medium text-rose-300">Bạn không có quyền truy cập trang đó</p>
            </div>
          )}
