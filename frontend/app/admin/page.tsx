        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 shrink-0">
          ...
          <div className="bg-zinc-900/40 border border-zinc-900 rounded-3xl p-5 lg:col-span-2 flex flex-col justify-between h-[250px] shrink-0">
            <div className="flex items-center justify-between shrink-0">
              <div>
                <h2 className="text-sm font-bold text-white">Doanh Thu Theo Giờ</h2>
                <p className="text-[11px] text-zinc-400 font-light mt-0.5">Thống kê doanh số bán hàng trong ngày hôm nay.</p>
              </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-zinc-900 text-[10px] font-bold text-zinc-500 uppercase tracking-wider bg-zinc-950/80">
                  ...
                  <th className="px-5 py-3 sticky top-0 bg-zinc-950/90 backdrop-blur z-10">Khách Hàng / Bàn</th>
              ...
              <tbody className="divide-y divide-zinc-900 text-xs">
                {filteredTransactions.map(trans => (
                  <tr key={trans.id} className="hover:bg-zinc-900/20 transition-all">
                    ...
                    <td className="px-5 py-3 text-center font-mono text-zinc-300">{trans.itemsCount}</td>
