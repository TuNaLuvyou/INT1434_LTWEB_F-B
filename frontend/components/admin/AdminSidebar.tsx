...
const NAV_ITEMS = [
  { key: "dashboard", href: "/admin/dashboard", icon: LayoutDashboard, allowedRoles: ["ADMIN", "MANAGER"] as Role[] },
  { key: "menuManagement", href: "/admin/menu", icon: Utensils, allowedRoles: ["ADMIN", "MANAGER"] as Role[] },
  { key: "inventory", href: "/admin/inventory", icon: Database, allowedRoles: ["ADMIN", "MANAGER"] as Role[] },
  { key: "vouchers", href: "/admin/vouchers", icon: Ticket, allowedRoles: ["ADMIN", "MANAGER"] as Role[] },
  { key: "zreport", href: "/admin/z-report", icon: FileText, allowedRoles: ["ADMIN", "MANAGER"] as Role[] },
  { key: "integrations", href: "/admin/integrations", icon: Webhook, allowedRoles: ["ADMIN"] as Role[] },
  { key: "roles", href: "/admin/roles", icon: ShieldAlert, allowedRoles: ["ADMIN"] as Role[] },
  { key: "bankAccount", href: "/admin/bank-account", icon: CreditCard, allowedRoles: ["ADMIN"] as Role[] },
  { key: "auditLogs", href: "/admin/audit-logs", icon: Activity, allowedRoles: ["PLATFORM_ADMIN"] as Role[] },
  { key: "invoices", href: "/admin/invoices", icon: FileInvoice, allowedRoles: ["PLATFORM_ADMIN"] as Role[] },
  { key: "settings", href: "/admin/settings", icon: Settings, allowedRoles: ["ADMIN"] as Role[] },
];
  ...
  return (
    <>
      ...
      >
        <div className="space-y-6">
          ...
          <nav className="space-y-1.5">
            {NAV_ITEMS.map((tab) => {
              ...
              return (
                <RoleGate key={tab.key} allowedRoles={tab.allowedRoles}>
                  <Link
                    href={tab.href}
                    onClick={() => setIsMobileOpen(false)}
        ...
        <div className="space-y-3 pt-4 border-t border-zinc-900">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-xs font-semibold text-rose-400 hover:text-white hover:bg-rose-500/10 transition-all"
          >
      ...
      <aside
        ...
        className={`hidden lg:flex flex-col justify-between bg-zinc-950 border-r border-zinc-900 h-screen sticky top-0 transition-all duration-300 z-20 shrink-0 ${
