  ...
  try {
    ...
    const config = await prisma.systemConfig.upsert({
      ...
      update: { 
        ...
        pointEarnRate: pointEarnRate !== undefined ? Number(pointEarnRate) : undefined,
        pointRedeemRate: pointRedeemRate !== undefined ? Number(pointRedeemRate) : undefined,
        pointResetPeriodMonths: pointResetPeriodMonths !== undefined ? (pointResetPeriodMonths === null || pointResetPeriodMonths === '' ? null : Number(pointResetPeriodMonths)) : undefined,
      },
      create: {
        tenantId,
        restaurantName: finalRestaurantName,
        ...
        pointEarnRate: pointEarnRate !== undefined ? Number(pointEarnRate) : 10000,
        pointRedeemRate: pointRedeemRate !== undefined ? Number(pointRedeemRate) : 100,
        pointResetPeriodMonths: pointResetPeriodMonths !== undefined && pointResetPeriodMonths !== null && pointResetPeriodMonths !== '' ? Number(pointResetPeriodMonths) : null,
      }
    });
