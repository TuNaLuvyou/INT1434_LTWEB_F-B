...
export class MenuController {
  ...
  static async getMenu(
    ...
    try {
      const { branchId, categoryId, soldOut, tableId } = req.query;
      const tenantId = (req.query.tenantId as string) || (req as any).apiKey?.tenantId;
      ...
      const result = await MenuService.getMenu(tenantId as string, branchId as string, categoryId, soldOut, tableId as string);
