...
export async function processPaymentHandler(req: Request, res: Response): Promise<void> {
  try {
    ...
    const { method, voucherId, customerPhone, usePoints, pointsToUse, subtotal, discountAmount, total, keepOccupied, items } = req.body;
    ...
    const result = await paymentService.processPayment({
      ...
      usePoints: !!usePoints,
      pointsToUse: typeof pointsToUse === 'number' ? pointsToUse : undefined,
      subtotal,
      discountAmount,
      total,
